...
Public Class DBRD_S2P
    ...
    Public Overrides Sub Run(ByVal sender As Object, ByVal e As DoWorkEventArgs)
        ...
        Try
            ...
            Dim prompt1 As String = "Connect DFETB1 to DBRD Input Connector and DFETB2 to the DBRD Output Connector " & tp.Port
            ...
            DFETB2 = CType(_instrumentList("DFETB2"), BdsDfeTestBoard)
            DFETB.InitializeInstrument()
            DFETB2.InitializeInstrument()
            ...
            For Each sp As SweepParameters In SweepList
                ...
                DFETB2.RfSwitchPath = sp.DfeTbSwitchPath
